...
if __name__ == "__main__":
    translator = Translator(
        ...
        embedding_dimension = 512, # It is the dimension that all tokens will receive to capture more complex semantic relationships between words.
        number_heads = 9, # Number heads used in the self-attention process
        ...
        limit_sequence_length = 100, # Word limit on the transformer output.
