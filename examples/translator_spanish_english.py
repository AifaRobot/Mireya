...
spanish_words = {
    "<PAD>": 0, "<SOS>": 1, "<EOS>": 2, "hola": 3, "mundo": 4, "cuantos": 5, "años": 6, "tienes": 7,
    "tu": 8, "quien": 9, "eres": 10, "como": 11, "estas": 12,
}
"""Dictionary of English words. Each word is a number that will be used to generate a token"""
english_words = {
    "<PAD>": 0, "<SOS>": 1, "<EOS>": 2, "hello": 3, "world": 4, "how": 5, "old": 6, "are": 7, "you": 8,
    "who": 9,
}
...
if __name__ == "__main__":
    ...
    translator("quien eres")
    translator("como estas")