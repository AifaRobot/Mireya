...
class MultiHeadAttention(nn.Module):
    ...
    # The combine_heads function is the reverse operation of split_heads in the multi-head attention mechanism. Its purpose is to recombine
    # the results of the multiple attention heads into a single output tensor that has the same original dimension. This is done
    # after each head has calculated its attention independently
