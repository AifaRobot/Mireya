...
class DecoderLayer(nn.Module):
    ...
    def forward(self, _, memory):
        decoder_output = memory.get_decoder_tensor()
        decoder_output_mask = memory.get_decoder_mask()
        ...
        if memory.get_encoder_tensor() != None:
            encoder_output = memory.get_encoder_tensor()
            encoder_output_mask = memory.get_encoder_mask()
